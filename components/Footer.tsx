...
const Footer = () => {
  return (
    <div className='flex bg-[#f60] shadow-[0_0_0_2px_#000,8px_8px_0_0_#34cc98] mb-9 md:w-4/5 justify-center items-center font-bold my-3 py-4 flex-wrap px-4 mt-9 md:mx-16 mx-8'>
      <div>
        <Link

...
export default function Header() {
  ...
  return (
    <nav
      className={`flex mx-auto items-center justify-between bg-[#AA13AD] py-1 md:py-0 px-5 md:px-7 mt-8 md:mt-24 sticky top-0 z-50 transition-all ease-in duration-200 ${
        isSticky ? 'w-full rounded-none' : 'rounded-full md:w-[62.5%] w-11/12'
      }`}
    >
      <Link href='/'>
        <Image

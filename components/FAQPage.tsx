  ...
  const FAQs = [
    {
      ...
      answer:
        'The initial step on the website involves registering for accommodation by providing the necessary details. Following the completion of the accommodation details, the next step involves making the payment. Once the payment is processed, users receive their unique Inno-Code, confirming their accommodation. Subsequently, the confirmation of accommodation is provided by the  accommodation heads of Moksha-Innovision.',
    },
    {
      question: 'When will my accommodations be confirmed?',
      answer:
        'You first need to register and pay for accomodation for Moksha-Innovison and get your Inno-Code. Your accommodation will then be confirmed by the accomodation heads of Moksha-Innovision. The confirmation for the same will be communicated to the CL, who will convey the same to you, and you will also receive a mail regarding it by the first week of March.',
    },
    {
      question: 'Where will the accommodations be provided?',
      answer:
        'Accommodation will be provided to boys and girls in well-secured partner hotels of Moksha-Innovision near the campus. There will be accommodation provisions for our visitors to ensure the safety of everyone.',
    },
    {
      question:
        'Will the team members be given accommodation at the same place?',
      answer:
        'We will try our best to provide you with this arrangement, but no confirmation can be given. We request that you do not ping the accommodation team for the same.',
    },
    {
      question:
      ...
      answer:
        'You should nominate a leader amongst yourselves, get it approved from the Moksha-Innovision authorities, and then proceed in the same manner.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Yes, you can definitely attend MV by registering at your respective colleges. However, for accommodation, you can contact the CL of your college and fill out the accommodation request. If your college does not have any CLs, choose one leader amongst yourselves to represent your entire group. Accommodation would be confirmed strictly subject to availability.',
    },
    {
